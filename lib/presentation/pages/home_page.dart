...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final menuItems = [
      _MenuItem(icon: Icons.picture_as_pdf_rounded, iconColor: AppColors.accentOrange,
        label: loc.btnPdfToImage, subtitle: 'PDF → PNG / JPG',
        onTap: () => _push(context, const PdfToImagePage())),
      _MenuItem(icon: Icons.image_rounded, iconColor: AppColors.accentTeal,
        label: loc.btnImageToPdf, subtitle: 'PNG / JPG → PDF',
        onTap: () => _push(context, const ImageToPdfPage())),
      _MenuItem(icon: Icons.description_rounded, iconColor: Colors.blue,
        label: 'Word to Image', subtitle: 'DOC / DOCX → PNG / JPG',
        onTap: () => _push(context, const WordToImagePage())),
      _MenuItem(icon: Icons.merge_type_rounded, iconColor: AppColors.accentPrimary,
        label: 'Merge PDFs', subtitle: 'PDF + PDF → PDF',
        onTap: () => _push(context, const MergePdfPage())),
      _MenuItem(icon: Icons.find_in_page_rounded, iconColor: AppColors.error,
        label: 'Extract Pages', subtitle: 'Halaman tertentu',
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [BoxShadow(color: AppColors.accentPrimary.withAlpha(100), blurRadius: 28, spreadRadius: 4)],
                        ),
                      ...
                      LayoutBuilder(builder: (context, constraints) {
                        ...
                        return Wrap(
                          ...
                          children: menuItems.map((item) => SizedBox(
                            width: cardW,
                            child: _GridCard(item: item, isDark: isDark),
                          )).toList(),
                        );
                      }),
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            ...
            width: _hov ? 1.5 : 1),
          boxShadow: _hov
              ? [BoxShadow(color: AppColors.accentPrimary.withAlpha(35), blurRadius: 24, offset: const Offset(0, 6))]
